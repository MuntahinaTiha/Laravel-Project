...
$(function () {
    ...
    //         Clear cart after order  commentout করা হয়েছে কারণ এখন আমরা backend এ order save করবো, তাই cart clear করার logic backend থেকে আসবে response হিসেবে, এখন শুধু console log করে দেখাচ্ছি যে order place হচ্ছে কিনা, এবং কোন payment method select করা হয়েছে কিনা
    //         cart = [];
    //         saveCart();
    //         renderAll();
    //         renderCheckout();
