                   ...
                   <div class="row">
                       ...
                       <div class="col-lg-4">
                           <div class="order-summary">
                               ...
                               {{-- <div class="order_items" id="orderItems"></div> --}}
                               <div class="total_amount">
                                   ...
                                   @forelse ($cart as $data)
                                       <div class="row align-items-center mb-3">
                                           ...
                                           <div class="col-8">
                                               <b class="mb-0 pb-0">{{ $data['title'] }}</b>
                               ...
                               <div class="payment_method">
                                   <label><input id="cod" style="width: 15px; height: 15px; " type="radio"
                                           name="payment" value="cod" checked>
                                       Cash on Delivery</label>
                                   <label><input id="online" style="width: 15px; height: 15px; " type="radio"
