...
@section('backend_content')
    <div class="card p-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-primary" href="">List Users</a>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 text-center position-relative">
                        <span class="remove_btn"
                            style="position: absolute; right: 25px; top: -8px; line-height: 0; color: red; border: 1px solid red; display: none;
                        align-items: center; padding: 8px; border-radius: 10px; cursor: pointer;"><iconify-icon
                                icon="pajamas:remove" width="16" height="16"></iconify-icon></span>
                        <label for="imgInp">
                            <img id="user_image"
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-2">
                                ...
                                <input type="password" class="form-control p-3" placeholder="password" name="user_password">
