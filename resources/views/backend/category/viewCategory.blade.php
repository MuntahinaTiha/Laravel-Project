            ...
            <table class="table table-bordered table-striped">
                ...
                @forelse ($categories as $key=>$category)
                    <tr class="text-center">
                        ...
                        <td><span class="badge bg-{{ $category->parents ? 'success' : 'danger' }}">{{ $category->parents ? 'FOUND' : 'NOT FOUND' }}</span></td>
                        ...
                        <td>
                            <div class="d-flex justify-content-evenly">
                                <a href="{{ route('dashboard.category.edit', $category->slug) }}"><iconify-icon
                                        icon="fa-regular:edit" width="20" height="20"></iconify-icon></a>
                                <a class="text-danger"
                                    href="{{ route('dashboard.category.delete', $category->id) }}"><iconify-icon
                                        icon="fluent:delete-32-regular" width="22" height="22"></iconify-icon></a>
                            </div>
                        </td>
                    </tr>
                @empty
